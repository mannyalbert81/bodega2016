	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <td style="color:#000000;font-size:80%;"> <?php echo $res->nombre_tipo_operaciones; ?>     </td> 
		           	   ...
		           	   <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("TipoOperaciones","index"); ?>&id_tipo_operaciones=<?php echo $res->id_tipo_operaciones; ?>" class="btn btn-warning" style="font-size:65%;">Editar</a>
			                </div>
			            
			             </td>
			             <td>   
			                	<div class="right">
			                    <a href="<?php echo $helper->url("TipoOperaciones","borrarId"); ?>&id_tipo_operaciones=<?php echo $res->id_tipo_operaciones; ?>" class="btn btn-danger" style="font-size:65%;">Borrar</a>
			                </div>
			                <hr/>
		               </td>
		    		</tr>
