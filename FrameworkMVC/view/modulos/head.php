  ...
  <div  style="margin-top: 20px;" class="col-xs-6 col-md-4">
		...
		?>
		  ...
		  <div class="col-xs-7 col-md-5">
			...
			<div class="dropdown">
				  <button class="btn btn-warning dropdown-toggle" type="button" data-toggle="dropdown"><span class="glyphicon glyphicon-user" ><FONT  SIZE=2><?php echo " ".$_SESSION['usuario_usuarios'];?></FONT></span>
