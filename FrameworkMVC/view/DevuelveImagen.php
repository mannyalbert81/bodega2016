...
$image = "";
//$conn  = pg_connect("user=postgres port=5432 password=.Romina.2012 dbname=bodega host=192.168.100.3");
$conn  = pg_connect("user=postgres port=5433 password=.Romina.2012 dbname=bodega host=186.4.241.148");
if(!$conn)
{
