	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <td style="color:#000000;font-size:80%;"> <?php echo $res->nombre_bodegas; ?>     </td> 
		           	   ...
		           	   <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("Bodegas","index"); ?>&id_bodegas=<?php echo $res->id_bodegas; ?>" class="btn btn-warning" style="font-size:65%;">Editar</a>
			                </div>
			            
			             </td>
			             <td>   
			                	<div class="right">
			                    <a href="<?php echo $helper->url("Bodegas","borrarId"); ?>&id_bodegas=<?php echo $res->id_bodegas; ?>" class="btn btn-danger" style="font-size:65%;">Borrar</a>
			                </div>
			                <hr/>
		               </td>
		    		</tr>
