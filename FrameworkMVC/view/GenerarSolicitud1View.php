...
<html lang="es">
  ...
  <div class="row" style="background-color: #ffffff;">
    ...
    <?php if ($resultEdit !="" ) { foreach($resultEdit as $resEdit) {?>
		  ...
		  <h4 ALIGN="center"></h4>
		   <hr/>
		    <h4 style="color:#ec971f;" ALIGN="center" >GENERAR  SOLICITUD DE CARTONES</h4>
           ...
           <p  class="formulario-subtitulo" >Cartones</p>
			  	<select  name="origen[]" id="origen" multiple="multiple" size="20" class="form-control">
			 
			  	<?php foreach($resultCartones as $resCartones) {?>
			
			     <option value="<?php echo $resCartones->id_cartones; ?>" <?php if($sel_id_cartones==$resCartones->id_cartones){echo "selected";}?> ><?php echo $resCartones->contenido_cartones,- $resCartones->numero_cartones,- $resCartones->serie_cartones,- $resCartones->cantidad_documentos_libros_cartones,- $resCartones->year_cartones ; ?> </option>
			        <?php } ?>
				</select> 			  
			  </div>
