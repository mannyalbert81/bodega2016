...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Anular Solicitud - bodega 2016</title>
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("AnularSolicitud","InsertaAnularSolicitud"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12">
    ...
    <?php if ($resultEdit !="" ) { foreach($resultEdit as $resEdit) {?>
		  ...
		  <h4 ALIGN="center"></h4>
		   <hr/>
		    <h4 style="color:#ec971f;" ALIGN="center" >ANULAR  SOLICITUD DE CARTONES</h4>
