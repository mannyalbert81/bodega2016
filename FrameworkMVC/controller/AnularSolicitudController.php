...
class AnularSolicitudController extends ControladorBase{
	...
	public function index(){
		...
		if (isset(  $_SESSION['usuario_usuarios']) )
		{
			...
			$nombre_controladores = "AnularSolicitud";
			...
			if (!empty($resultPer))
			{
					...
					if (isset ($_GET["id_movimientos"])   )
					{
						...
						if (!empty($resultPer))
						{
							...
							$_nombre_controlador = "AnularSolicitud";
						...
						else
						{
							$this->view("Error",array(
									"resultado"=>"No tiene Permisos de Editar Anular Solicitud"
					...
					$this->view("AnularSolicitud",array(
	...
	public function InsertaAnularSolicitud(){
		...
		if (!empty($resultPer))
		{
			...
			if (isset ($_POST["Guardar"])   )
			{
				...
				$resultOperaciones = $operaciones->getBy("nombre_tipo_operaciones LIKE 'ANULAR%' ");
			...
			$this->redirect("AnularSolicitud", "index");
		...
		{
			$this->view("Error",array(
					"resultado"=>"No tiene Permisos de Guardar Anular Solicitud"
